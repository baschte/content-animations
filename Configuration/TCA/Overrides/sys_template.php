...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile('content_animations', 'Configuration/TypoScript/HigherEducationPackage/v11', 'Content Animations: Higher Education Package v11');
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile('content_animations', 'Configuration/TypoScript/HigherEducationPackage/v10', 'Content Animations: Higher Education Package v10');
