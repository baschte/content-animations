...
.. hint::
  ...
  **Example:** If you use the Bootstrap Package in version 13.0.x in your project you have to include ``Content Animations: Bootstrap Package v13.x``. If it's in version 12 the ``Content Animations: Bootstrap Package v12.x`` and so on.
