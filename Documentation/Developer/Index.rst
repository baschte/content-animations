...
Content Animations comes with an out of the box **bootstrap_package v13, v12, v11, v10, v9 and v8**, **fluid_styled_content** and **higher_education_package v11** support. Just include the static typoscript of your used extension (for example Bootstrap Package) into the site template and you're good to go.
